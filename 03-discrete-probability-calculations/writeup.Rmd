...
```{r}
(0.5 * pbinom(3,7,0.55,lower.tail = FALSE)) / ((0.5 * pbinom(3,7,0.55,lower.tail = FALSE))+ (0.5 * pbinom(3,7,0.45,lower.tail = FALSE)) )
```
So, P(P<sub>b</sub> = 0.55 | Braves win World Series in 7 games) = P(P<sub>b</sub> = 0.55 ∩ Braves win World Series in 7 games) / P(B) <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OR <br>
= P(B) * P(Braves win World Series in 7 games | P<sub>b</sub> = 0.55) / ((P(B) * P(Braves win World Series in 7 games | P<sub>b</sub> = 0.55) + (P(B) * P(Braves win World Series in 7 games | P<sub>b</sub> = 0.55)) = 0.6082878
