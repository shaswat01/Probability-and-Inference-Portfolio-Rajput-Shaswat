...
```{r}
#Browser functioin after the function ois gonna open up all the variables and we can look them up.
# If you are in iteration then use c in console to go to the next iteration and see. Add length at end. In plot(type='')
```
