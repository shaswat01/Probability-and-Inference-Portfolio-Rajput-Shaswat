...
```
<li>As we can see MAE decreases as number of replicates.</li>
```{r}
plot.new()
...
```
<li> Same goes for the MRE, as number of replicates increases, MRE decreases. <br>
As they can't be distinguished at large replicates, what we can do is we can use log10 scale for the y axis to be able to see the difference.</li>
```{r}
